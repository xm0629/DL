...
class VGGNet(VGG):
    def __init__(self, pretrained=True, model='vgg16', requires_grad=True, remove_fc=True, show_params=False):
        ...
        # 如果有预训练模型直接加载默认 True,eg 'resnet18-5c106cde.pth'
        # 如果 False 没有预训练模型则构建网络结构,  
        if pretrained:
            exec("self.load_state_dict(%s(pretrained=True).state_dict())" % model)
...
ranges = {'vgg11': ((0, 3), (3, 6),  (6, 11),  (11, 16), (16, 21)),
...
class FCN32s(nn.Module):
    def __init__(self, pretrained_net, n_class):
        ...
        self.pretrained_net = pretrained_net # 预训练网络
